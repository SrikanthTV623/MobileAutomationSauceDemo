...
public class BasePage {
    ...
    public void performDoubleTap(WebElement element) {
        ...
        int x = buttonLocation.getX() + element.getSize().getWidth() / 2;
        int y = buttonLocation.getY() + element.getSize().getHeight() / 2;
        ...
        Sequence doubleTapSequence = new Sequence(finger1, 1)
                ...
                .addAction(finger1.createPointerDown(PointerInput.MouseButton.LEFT.asArg()))
                .addAction(finger1.createPointerUp(PointerInput.MouseButton.LEFT.asArg()))
                .addAction(new Pause(finger1, Duration.ofMillis(200))) // Adjust pause duration if needed
                .addAction(finger1.createPointerMove(Duration.ZERO, PointerInput.Origin.viewport(), x, y))
                .addAction(finger1.createPointerDown(PointerInput.MouseButton.LEFT.asArg()))
                .addAction(finger1.createPointerUp(PointerInput.MouseButton.LEFT.asArg()));
    ...
    public void performScrollInBasePage() {
        // Scroll Logic
